export default {
  ...
  clash_royale: {
    ...
    slideIndex: 7,
    tagline: '',
    eventDescription: 'Will be updated soon',
    generalRules: 'Will be updated soon',
    rulesPdf: '',
    registrationDetails: 'Will be updated soon',
  ...
  t_shirt_painting: {
    ...
    contacts: [
      ...
      {name: 'SANGBIT CHAKRABORTY', mobile: '+91 8017343016'}
    ]
  },
