    ...
    return(
      <div className='Events'>
        <div className='contentWrap'>
          <EventIcon />
          <EventList id="1" eventCategory={coding} categoryName='CODING' />
          <EventList id="2" eventCategory={robotics} categoryName='ROBOTICS' />
          <EventList id="3" eventCategory={gaming} categoryName='GAMING' />
          <EventList id="4" eventCategory={creative} categoryName='CREATIVE' />
          <EventList id="5" eventCategory={geek} categoryName='GEEK' />
          <EventList id="6" eventCategory={fun} categoryName='FUN' />
        </div>
      </div>
    );
  }
